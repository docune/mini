...
public class MailHelper {
	...
	/**
	 * 메일 서버에 대한 인증 정보를 리턴해 주기 위한 클래스 이 안에서만 사용되는 클래스 이므로 Inner Class로 설정한다.
	 */
	// import javax.mail.Authenticator
	public class SMTPAuthenticator extends Authenticator {
		...
		public PasswordAuthentication getPasswordAuthentication() {
			...
			return new PasswordAuthentication("dokin1@gmail.com", "8509tygh");
		}
	}
	 ...
	 */
	public boolean sendMail(String sender, String receiver, String subject,
			String content) {
		...
		p.put("mail.smtp.user", "dokin1@gmail.com");
