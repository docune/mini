...
<form class="edit_comment form-horizontal" method="post"
	action="ajax/edit_comment.jsp">
	<!-- 글 번호 상태 유지 -->
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="email" name="email" id="email" class="form-control"
					placeholder="이메일" value='<%=comment.getEmail()%>' />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea class="form-control" name="content" id="content"
					style="resize: none; height: 80px"><%=comment.getContent()%></textarea>
			</div>
		</div>
