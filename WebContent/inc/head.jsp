...
<!-- jQuery Validate 스크립트 -->
<script type="text/javascript" src="<%=rootDir%>/assets/js/jquery.validate.min.js"></script>
<!-- CKEditor -->
...
<link rel="stylesheet"
href="<%=rootDir%>/assets/plugins/multi-column/multi-columns-row.css" />