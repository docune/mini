...
<%
	...
	// 0번째부터 상위 5개의 글을 조회하도록 Limit 조건 설정
			...
			<div class="item <%=clsName%>">
				...
				<div class="container">
					<div class="carousel-caption">
						...
						<!-- 읽기로 가기 위한 링크 -->
						<a
							href="bbs/read.jsp?bbs_type=gallery&document_id=<%=item.getId()%>"
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="clearfix" style="margin-bottom: 10px">
					<h3 class="pull-left" style="margin: 0px; padding: 0px">공지사항</h3>
					<div class="pull-right">
						<a href="bbs/list.jsp?bbs_type=notice"
				...
				<ul class="list-group">
					...
					<li class="list-group-item"><a
						href="bbs/read.jsp?bbs_type=notice&document_id=<%=notice.getId()%>">
							<%=notice.getSubject()%></a></li>
					<%
						}
						}
					%>
			...
			<div class="col-md-4">
				<div class="clearfix" style="margin-bottom: 10px">
					<h3 class="pull-left" style="margin: 0px; padding: 0px">자유게시판</h3>
					<div class="pull-right">
						<a href="bbs/list.jsp?bbs_type=free"
							class="btn btn-xs btn-success"> more</a>
					</div>
				</div>
				<ul class="list-group">
					<!-- 글 목록 -->
					...
					%>
					<li class="list-group-item"><a
						href="bbs/read.jsp?bbs_type=free&document_id=<%=free.getId()%>">
							<%=free.getSubject()%></a></li>
					<%
						}
						}
					%>
			...
			<div class="col-md-4">
				<div class="clearfix" style="margin-bottom: 10px">
					<h3 class="pull-left" style="margin: 0px; padding: 0px">질문/답변</h3>
					<div class="pull-right">
						<a href="bbs/list.jsp?bbs_type=qna" class="btn btn-xs btn-warning">
							more</a>
					</div>
				</div>
				<ul class="list-group">
					...
					%>
					<li class="list-group-item"><a
						href="bbs/read.jsp?bbs_type=qna&document_id=<%=qna.getId()%>">
							<%=qna.getSubject()%></a></li>
					<%
						}
						}
