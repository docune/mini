	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-4 text-center">
				<img src="../assets/img/html5.jpg" class="img-circle" 
				width="240" height="240"/>
				<h2>HTML5</h2>
				<p>
					웹 접근성과 시멘틱 웹, 그리고 XTHML1.0과 HTML5의 차이점에 대한 이해는 반응형 웹을 시작하는 첫 단계 입니다.
					그렇기 때문에 이 단원에서는 가장 우선적으로 HTML5의 변경된 웹 페이지 구성 방법과, 새롭게 추가된 시멘틱 요소들 및 멀티미디어 제어 요소들을 소개하고 기본적인 활용 과정을 소개합니다.
				</p>
			</div>
			...
			<div class="col-md-4 text-center">
				<img src="../assets/img/css3.jpg" class="img-circle"
				width="240" height="240"/>
				<h2>CSS3</h2>
				<p>
					기존에 사용되던 CSS2와 함께 사용할 수 있는 다채로운 그래픽 효과에 대해서 소개합니다. CSS3의 그림자,그라데이션 효과는 이미지 제작 없이 상당수의 웹 페이지들을 CSS만으로 제작 가능하게 해 주었습니다.
					CSS3는 CSS2에 효과들이 추가되는 개념이기 때문에 웹 표준 기술(XHTML1.0+CSS2)에 대한 이해가 필요합니다.
				</p>
			</div>
			<div class="hidden-lg hidden-md">
				<br/>
		...
		<div class="row featurette">
			<div class="col-md-5">
				<img class="img-thumbnail img-responsive" src="../assets/img/img02.jpg" width="500" height="500" />
			</div>
			<div class="col-md-7">
		...
		<div class="row featurette">
			...
			<div class="col-md-5">
				<img class="img-thumbnail img-responsive" src="../assets/img/img03.jpg" width="500" height="500" />
			</div>
		</div>
	</div>
	<!-- // 내용영역 -->
