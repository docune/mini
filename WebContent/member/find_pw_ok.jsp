...
<%
	...
	// 이메일과 새 비밀번호를 지정하는 Beans 생성하기
	Member member = new Member (0, null, new_password, null,
	...
	String sender = "dokin1@gmail.com";
	...
	if (!is_send) {
		helper.redirect(null, "메일 발송에 실패했습니다. 관리자에게 문의 바랍니다.");
		return;
	}
